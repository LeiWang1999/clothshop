<template>
	<view>
		<uni-section title="配送模板列表" type="line">
			<view class="button" @click="toAddShippingTemplate"><text class="button-text">新建模板</text></view>
		</uni-section>
		<uni-swipe-action>
			<uni-swipe-action-item v-for="(item,index) in swipeList" :options="item.options" :key="item.id" :data-pageTitle="item.temName"
...
<script>
	...
	import { getData,delData } from '@/common/api/shipping-template.js'
	export default {
		components: {
			uniSection,
			uniSwipeAction,
