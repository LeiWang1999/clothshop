	...
	<view v-show="show" class="t-wrapper" @touchmove.stop.prevent="moveHandle">
		...
		<view class="t-box" :class="{active:active}">
			...
			<view class="t-color__box" :style="{ background: 'rgb(' + bgcolor.r + ',' + bgcolor.g + ',' + bgcolor.b + ')'}">
				<view class="t-background boxs" @click="touchstart($event, 0)">
			...
			<view class="t-control__box">
				...
				<view class="t-control-box__item">
					<view class="t-controller boxs" @click="touchstart($event, 1)">
						<view class="t-hue">
							<view class="t-circle" :style="{ left: site[1].left - 12 + 'px' }"></view>
						</view>
					</view>
					<view class="t-controller boxs" @click="touchstart($event, 2)">
			...
			<view class="t-result__box">
				<view v-if="mode" class="t-result__item">
					<view class="t-result__box-input"><input class="uni-input" name="input"  @input="setHexColorValue" :value="hex" /></view>
					<view class="t-result__box-text">HEX</view>
				</view>
				<template v-else>
					<view class="t-result__item">
						<view class="t-result__box-input"><input class="uni-input" name="input" @input="setRColorValue" :value="rgba.r" /></view>
						<view class="t-result__box-text">R</view>
					</view>
					<view class="t-result__item">
						<view class="t-result__box-input"><input class="uni-input" name="input" @input="setGColorValue" :value="rgba.g" /></view>
						<view class="t-result__box-text">G</view>
					</view>
					<view class="t-result__item">
						<view class="t-result__box-input"><input class="uni-input" name="input" @input="setBColorValue" :value="rgba.b" /></view>
						<view class="t-result__box-text">B</view>
					</view>
					<view class="t-result__item">
						<view class="t-result__box-input"><input class="uni-input" name="input" @input="setAColorValue" :value="rgba.a" /></view>
	...
	export default {
		...
		methods: {
			...
			open(pColor,pItem) {
				...
				this.show = true;
				this.$nextTick(() => {
					this.rgba=this.hexToRgb(pColor)
					console.log(pColor);
			...
			setHexColorValue(e){
				...
				let res = this.hexToRgb(this.hex);
				if(""!=res){
					this.rgba = res;
					this.hsb = this.hex
				}
			...
			hexToRgb(e){
			    ...
			    if(sColor && reg.test(sColor)){
					  ...
					  let tmp = {r:sColorChange[0],g:sColorChange[1],b:sColorChange[2],a:1};
