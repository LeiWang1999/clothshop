		...
		<view :class="edit?'v-root-edit':'v-root-edit-preview'" :style="'background:'+proData.backgroundColor" @click="showState==0?togglePopup('bottom', 'popup'):''">
			<view class="v-item-pro" v-if="proData.template==1&&proData.proList.length==0" :style="'padding-left:'+proData.pageMargin+'rpx;padding-right:'+proData.pageMargin+'rpx'">
				<view>
					...
					<view class="item-pintuan">
						<text class="pt-title">拼团</text>
						<view class="pt-countdown">
							<text class="cd-txt">距结束仅剩</text>
							<view style="margin-top: -3px;">
								<text class="cd-num">1</text><text class="cd-tip">天</text>
								<text class="cd-num">1</text><text class="cd-tip">时</text>
								<text class="cd-num">1</text><text class="cd-tip">分</text>
								<text class="cd-num">1</text><text class="cd-tip">秒</text>
							</view>
						</view>
					</view>
				</view>
				<view class="v-pro-info">	
					...
					<view style="height: 37px;padding-top: 5px;" v-if="proData.textAlign=='left'">
						...
						<text v-if="proData.showContent[2].checked==true" class="t-pro-price t-pre-price" :style="'font-weight:'+proData.fontWeight">¥33</text>
