		...
		<view :class="[direction==='column'?'uni-steps__column':'uni-steps__row']">
			...
			<view :class="[direction==='column'?'uni-steps__column-container':'uni-steps__row-container']">
				<view :class="[direction==='column'?'uni-steps__column-line-item':'uni-steps__row-line-item']" v-for="(item,index) in options" :key="index">
					...
					<image v-if="index==0" src="../../../static/img/emptyCart.jpg" style="width: 40px;height: 40px;position: absolute;margin-left: 600rpx;"></image>
					<button v-if="index==1" style="position: absolute;margin-left: 600rpx;font-size: 14px;">发送</button>
				</view>
			</view>
		</view>
	</view>
